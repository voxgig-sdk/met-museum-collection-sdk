...
describe("ObjectEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set METMUSEUMCOLLECTION_TEST_OBJECT_ENTID JSON to run live")
      return
    end
...
function object_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("METMUSEUMCOLLECTION_TEST_OBJECT_ENTID")
