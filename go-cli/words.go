...
func registerSDKWords(r *eng.Registry, client *sdk.MetMuseumCollectionSDK) {
...
func runOp(client *sdk.MetMuseumCollectionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
