...
AQL-driven CLI and REPL for the MetMuseumCollection SDK. Positional arguments are
...
```sh
go build -o met-museum-collection-cli ./...
```
...
./met-museum-collection-cli load 1 department
./met-museum-collection-cli load '{id:1}' department
