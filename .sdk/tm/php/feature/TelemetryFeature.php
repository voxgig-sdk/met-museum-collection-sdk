...
// MetMuseumCollection SDK telemetry feature
...
class MetMuseumCollectionTelemetryFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _close(MetMuseumCollectionContext $ctx, bool $ok): void
    {
