...
// MetMuseumCollection SDK idempotency feature
...
class MetMuseumCollectionIdempotencyFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _mutating(MetMuseumCollectionContext $ctx): bool
    {
