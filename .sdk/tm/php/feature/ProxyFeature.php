...
// MetMuseumCollection SDK proxy feature
...
class MetMuseumCollectionProxyFeature extends MetMuseumCollectionBaseFeature
{
    ...
    public function init(MetMuseumCollectionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MetMuseumCollectionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
