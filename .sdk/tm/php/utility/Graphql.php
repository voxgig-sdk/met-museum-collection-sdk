...
// MetMuseumCollection SDK utility: graphql
//
...
class MetMuseumCollectionGraphql
{
    ...
    // equivalent.
    public static function body(MetMuseumCollectionContext $ctx): mixed
    {
    ...
    public static function errors(MetMuseumCollectionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
