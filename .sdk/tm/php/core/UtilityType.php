...
// MetMuseumCollection SDK utility type

class MetMuseumCollectionUtility
{
    ...
    public static function copy(MetMuseumCollectionUtility $src): MetMuseumCollectionUtility
    {
        $u = new MetMuseumCollectionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
