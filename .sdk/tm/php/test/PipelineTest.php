...
// MetMuseumCollection SDK pipeline test
//
...
{
    private static function utility(): MetMuseumCollectionUtility
    {
        return new MetMuseumCollectionUtility();
    }
    ...
    private static function ctx(array $over = []): MetMuseumCollectionContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MetMuseumCollectionContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MetMuseumCollectionOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MetMuseumCollectionError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MetMuseumCollectionOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MetMuseumCollectionMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MetMuseumCollectionOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MetMuseumCollectionMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MetMuseumCollectionOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MetMuseumCollectionMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MetMuseumCollectionSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MetMuseumCollectionMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MetMuseumCollectionResponse([]),
            'result' => new MetMuseumCollectionResult([]),
        ]);
        [, $err] = MetMuseumCollectionMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MetMuseumCollectionSpec([]),
            'response' => null,
            'result' => new MetMuseumCollectionResult([]),
        ]);
        [, $err] = MetMuseumCollectionMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MetMuseumCollectionSpec(['step' => 's']),
            'response' => new MetMuseumCollectionResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MetMuseumCollectionResult([]),
        ]);
        [, $err] = MetMuseumCollectionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MetMuseumCollectionSpec(['step' => 's']),
            'response' => new MetMuseumCollectionResponse(self::resp(200, ['v' => 1])),
            'result' => new MetMuseumCollectionResult([]),
        ]);
        [, $err] = MetMuseumCollectionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MetMuseumCollectionSpec(['step' => 's']),
            'response' => new MetMuseumCollectionResponse(self::resp(200, ['v' => 2])),
            'result' => new MetMuseumCollectionResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MetMuseumCollectionMakeResponse::call($ctx);
    ...
    {
        $preset = new MetMuseumCollectionResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MetMuseumCollectionSpec([]),
            'response' => new MetMuseumCollectionResponse([]),
            'result' => new MetMuseumCollectionResult([]),
        ...
        [$got, $err] = MetMuseumCollectionMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MetMuseumCollectionResult([])]);
        [, $err] = MetMuseumCollectionMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MetMuseumCollectionSpec([]), 'result' => null]);
        [, $err] = MetMuseumCollectionMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MetMuseumCollectionSpec(['step' => 's']),
            'result' => new MetMuseumCollectionResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MetMuseumCollectionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MetMuseumCollectionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MetMuseumCollectionSpec(['step' => 's']),
            'result' => new MetMuseumCollectionResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MetMuseumCollectionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MetMuseumCollectionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MetMuseumCollectionResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MetMuseumCollectionSpec([]),
            'result' => new MetMuseumCollectionResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MetMuseumCollectionMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MetMuseumCollectionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MetMuseumCollectionError('boom', 'boom');
        $utility->fetcher = function (MetMuseumCollectionContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MetMuseumCollectionSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MetMuseumCollectionMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MetMuseumCollectionContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MetMuseumCollectionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MetMuseumCollectionResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MetMuseumCollectionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MetMuseumCollectionContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MetMuseumCollectionSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MetMuseumCollectionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MetMuseumCollectionResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MetMuseumCollectionSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MetMuseumCollectionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MetMuseumCollectionMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MetMuseumCollectionMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MetMuseumCollectionResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MetMuseumCollectionDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MetMuseumCollectionResult(['ok' => false])]);
        $this->expectException(MetMuseumCollectionError::class);
        MetMuseumCollectionDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MetMuseumCollectionResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MetMuseumCollectionMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MetMuseumCollectionMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MetMuseumCollectionBaseFeature();
        $b = new MetMuseumCollectionBaseFeature();
        MetMuseumCollectionFeatureAdd::call($ctx, $a);
        MetMuseumCollectionFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MetMuseumCollectionBaseFeature
    {
        $f = new MetMuseumCollectionBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MetMuseumCollectionFeatureAdd::call($ctx, self::named_feature('a'));
        MetMuseumCollectionFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MetMuseumCollectionFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MetMuseumCollectionFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MetMuseumCollectionFeatureAdd::call($ctx, $replace);
        ...
        MetMuseumCollectionFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MetMuseumCollectionContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MetMuseumCollectionSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MetMuseumCollectionPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MetMuseumCollectionPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MetMuseumCollectionResponse(['headers' => null]),
            'result' => new MetMuseumCollectionResult([]),
        ]);
        MetMuseumCollectionResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MetMuseumCollectionResultBody::call($ctx);
