...
class MetMuseumCollectionTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MetMuseumCollectionTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MetMuseumCollectionTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MetMuseumCollectionTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
