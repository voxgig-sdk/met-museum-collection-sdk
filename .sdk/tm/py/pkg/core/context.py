...
from projectname_sdk.core.control import MetMuseumCollectionControl
...
class MetMuseumCollectionContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MetMuseumCollectionControl()
        ...
        if isinstance(sp, MetMuseumCollectionSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MetMuseumCollectionResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MetMuseumCollectionResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MetMuseumCollectionOperation({})
    ...
    def make_error(self, code, msg):
        return MetMuseumCollectionError(code, msg, self)
