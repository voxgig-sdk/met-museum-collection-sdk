...
from metmuseumcollection_sdk.utility import register
...
class MetMuseumCollectionSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MetMuseumCollectionUtility()
    ...
    def get_utility(self):
        return MetMuseumCollectionUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MetMuseumCollectionSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Department(self, data=None) -> "DepartmentEntity":
        ...
        from metmuseumcollection_sdk.entity.department_entity import DepartmentEntity
    ...
    def Object(self, data=None) -> "ObjectEntity":
        ...
        from metmuseumcollection_sdk.entity.object_entity import ObjectEntity
        return ObjectEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from metmuseumcollection_sdk.entity.search_entity import SearchEntity
