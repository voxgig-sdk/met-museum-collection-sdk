# MetMuseumCollection SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MetMuseumCollectionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MetMuseumCollectionSDK(...) and MetMuseumCollectionSDK.test(...) become
#      MetMuseumCollectionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "metmuseumcollection_sdk"
_SDK_CLASS = "MetMuseumCollectionSDK"
