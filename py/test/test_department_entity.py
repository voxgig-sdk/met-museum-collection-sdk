...
class TestDepartmentEntity:
    ...
    def test_should_stream(self):
        ...
        base = MetMuseumCollectionSDK.test(seed, None)
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            sdk = MetMuseumCollectionSDK.test(
    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set MET_MUSEUM_COLLECTION_TEST_DEPARTMENT_ENTID JSON to run live")
        client = setup["client"]
...
def _department_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("MET_MUSEUM_COLLECTION_TEST_DEPARTMENT_ENTID"))
    if idmap_resolved is None:
        idmap_resolved = helpers.to_map(idmap)

    if env.get("MET_MUSEUM_COLLECTION_TEST_LIVE") == "TRUE":
    ...
    _live = env.get("MET_MUSEUM_COLLECTION_TEST_LIVE") == "TRUE"
    return {
        "client": client,
        "data": entity_data,
        "idmap": idmap_resolved,
        "env": env,
        "explain": env.get("MET_MUSEUM_COLLECTION_TEST_EXPLAIN") == "TRUE",
        "live": _live,
