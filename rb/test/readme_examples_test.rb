...
#      offline in seeded test mode (MetMuseumCollectionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MetMuseumCollection_sdk.rb")
  SDK_CLASS = "MetMuseumCollectionSDK"
  ...
  SDK_BASE = "MetMuseumCollection_sdk"
