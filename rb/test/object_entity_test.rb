...
class ObjectEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MET_MUSEUM_COLLECTION_TEST_OBJECT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def object_basic_setup(extra)
  ...
  entid_env_raw = ENV["MET_MUSEUM_COLLECTION_TEST_OBJECT_ENTID"]
