# MetMuseumCollection SDK Search entity
...
class SearchEntity
  ...
  def data_set(args)
    if args
      @_data = MetMuseumCollectionHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = MetMuseumCollectionHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Search>, Array] the matching Search items; raises MetMuseumCollectionError on failure
