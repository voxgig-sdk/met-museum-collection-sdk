...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/met-museum-collection` | `npm install @voxgig-sdk/met-museum-collection` |
| Python | `voxgig-sdk-met-museum-collection` | `pip install voxgig-sdk-met-museum-collection` |
| PHP | `voxgig-sdk/met-museum-collection` | `composer require voxgig-sdk/met-museum-collection` |
| Golang | `github.com/voxgig-sdk/met-museum-collection-sdk/go` | `go get github.com/voxgig-sdk/met-museum-collection-sdk/go` |
| Ruby | `voxgig-sdk-met-museum-collection` | `gem install voxgig-sdk-met-museum-collection` |
| Lua | `voxgig-sdk-met-museum-collection` | `luarocks install voxgig-sdk-met-museum-collection` |
