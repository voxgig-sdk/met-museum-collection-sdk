...
// MetMuseumCollection SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MetMuseumCollectionMakeRequest
{
    public static function call(MetMuseumCollectionContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MetMuseumCollectionResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MetMuseumCollectionResponse($fetched);
        } else {
