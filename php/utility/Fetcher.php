...
// MetMuseumCollection SDK utility: fetcher

class MetMuseumCollectionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MetMuseumCollectionSDK/1.0)';
    ...
    public static function call(MetMuseumCollectionContext $ctx, string $fullurl, array $fetchdef): array
    {
