...
The PHP SDK for the MetMuseumCollection API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Department(null)->list(null, null);
...
[$result, $err] = $client->MetMuseumCollection(null)->load(
    ["id" => "test01"], null
);
