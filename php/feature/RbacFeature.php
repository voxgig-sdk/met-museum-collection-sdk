...
// MetMuseumCollection SDK rbac feature
...
class MetMuseumCollectionRbacFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _required(MetMuseumCollectionContext $ctx): ?string
    {
    ...
    private function _reject(MetMuseumCollectionContext $ctx, string $required): void
    {
    ...
    private function _track(MetMuseumCollectionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
