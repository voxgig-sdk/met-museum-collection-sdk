...
// MetMuseumCollection SDK audit feature
...
class MetMuseumCollectionAuditFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _emit(MetMuseumCollectionContext $ctx, string $outcome): void
    {
