...
// MetMuseumCollection SDK cache feature
...
class MetMuseumCollectionCacheFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _through(MetMuseumCollectionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
