...
// MetMuseumCollection SDK paging feature
...
class MetMuseumCollectionPagingFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _is_list(MetMuseumCollectionContext $ctx): bool
    {
