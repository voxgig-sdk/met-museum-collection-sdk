...
// MetMuseumCollection SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MetMuseumCollectionTestFeature extends MetMuseumCollectionBaseFeature
{
    ...
    public function init(MetMuseumCollectionContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MetMuseumCollectionContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MetMuseumCollectionParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MetMuseumCollectionContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MetMuseumCollectionContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = MetMuseumCollectionParam::call($ctx, $k);
