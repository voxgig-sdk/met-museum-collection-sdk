...
// MetMuseumCollection SDK timeout feature
...
class MetMuseumCollectionTimeoutFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _with_timeout(MetMuseumCollectionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MetMuseumCollectionContext $_ctx, float $ms): void
    {
        $client = $this->client;
