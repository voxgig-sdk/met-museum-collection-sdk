...
// MetMuseumCollection SDK streaming feature
...
class MetMuseumCollectionStreamingFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _iterate(MetMuseumCollectionResult $result): \Generator
    {
    ...
    private function _streamable(MetMuseumCollectionContext $ctx): bool
    {
