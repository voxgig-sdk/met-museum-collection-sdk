...
// MetMuseumCollection SDK metrics feature
...
class MetMuseumCollectionMetricsFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _record(MetMuseumCollectionContext $ctx, bool $ok): void
    {
