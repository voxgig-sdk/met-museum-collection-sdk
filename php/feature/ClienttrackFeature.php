...
// MetMuseumCollection SDK clienttrack feature
...
class MetMuseumCollectionClienttrackFeature extends MetMuseumCollectionBaseFeature
{
    ...
    public function PostConstruct(MetMuseumCollectionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MetMuseumCollection-SDK';
