...
// MetMuseumCollection SDK netsim feature
...
class MetMuseumCollectionNetsimFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _simulate(MetMuseumCollectionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MetMuseumCollectionContext $ctx, array $applied): void
    {
        $client = $this->client;
