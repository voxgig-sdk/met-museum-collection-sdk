...
// MetMuseumCollection SDK ratelimit feature
...
class MetMuseumCollectionRatelimitFeature extends MetMuseumCollectionBaseFeature
{
    ...
    private function _acquire(MetMuseumCollectionContext $ctx): void
    {
    ...
    private function _track(MetMuseumCollectionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
