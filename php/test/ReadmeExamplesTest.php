...
// MetMuseumCollection SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MetMuseumCollectionSDK::test)
...
{
    private const SDK_CLASS = 'MetMuseumCollectionSDK';
    ...
    private const SDK_BASE = 'metmuseumcollection_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../metmuseumcollection_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
