...
type Args struct {
	Entity string         `json:"entity" jsonschema:"department | object | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MetMuseumCollectionSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "met-museum-collection_list",
		Description: "List records from MetMuseumCollection. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "met-museum-collection_load",
		Description: "Load a single record from MetMuseumCollection. " +
...
func runOp(client *sdk.MetMuseumCollectionSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MetMuseumCollectionSDK, name string) (sdk.MetMuseumCollectionEntity, error) {
