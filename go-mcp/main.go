// Command MetMuseumCollection-mcp is an MCP server exposing the MetMuseumCollection
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MetMuseumCollection_list  — list records of an entity
//	MetMuseumCollection_load  — load a single record of an entity
//
