...
type MetMuseumCollectionSDK struct {
	Mode     string
...
func (sdk *MetMuseumCollectionSDK) OptionsMap() map[string]any {
...
func (sdk *MetMuseumCollectionSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MetMuseumCollectionSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MetMuseumCollectionSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MetMuseumCollectionSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MetMuseumCollectionSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MetMuseumCollectionSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MetMuseumCollectionSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MetMuseumCollectionSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MetMuseumCollectionSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MetMuseumCollectionSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MetMuseumCollectionSDK {
	...
	sdk := NewMetMuseumCollectionSDK(sdkopts)
	sdk.Mode = "test"
