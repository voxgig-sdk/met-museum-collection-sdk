...
The Golang SDK for the MetMuseumCollection API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/met-museum-collection-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/met-museum-collection-sdk=../path/to/github.com/voxgig-sdk/met-museum-collection-sdk
```
...
```
github.com/voxgig-sdk/met-museum-collection-sdk/
...
The root package (`github.com/voxgig-sdk/met-museum-collection-sdk`) re-exports everything needed
