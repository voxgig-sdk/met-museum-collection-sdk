...
## Install
```bash
go get github.com/voxgig-sdk/met-museum-collection-sdk/go
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/met-museum-collection-sdk/go=../path/to/github.com/voxgig-sdk/met-museum-collection-sdk/go
```
