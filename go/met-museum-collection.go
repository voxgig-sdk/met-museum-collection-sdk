...
import (
	...
	"github.com/voxgig-sdk/met-museum-collection-sdk/go/entity"
	"github.com/voxgig-sdk/met-museum-collection-sdk/go/feature"
	_ "github.com/voxgig-sdk/met-museum-collection-sdk/go/utility"
)
...
// instead of `sdk.NewMetMuseumCollectionSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MetMuseumCollectionSDK  { return NewMetMuseumCollectionSDK(nil) }
func Test() *MetMuseumCollectionSDK { return TestSDK(nil, nil) }
