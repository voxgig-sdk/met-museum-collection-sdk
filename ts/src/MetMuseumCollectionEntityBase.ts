...
// `class AdviceEntity extends MetMuseumCollectionEntityBase<Advice>`.
class MetMuseumCollectionEntityBase<D = any> {
  name = ''
  name_ = ''
  Name = ''

  _client: MetMuseumCollectionSDK
  _utility: Utility
  _entopts: any
  _data: any
  _match: any
