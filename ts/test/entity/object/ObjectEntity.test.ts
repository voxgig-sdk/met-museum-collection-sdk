...
describe('ObjectEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set MET_MUSEUM_COLLECTION_TEST_OBJECT_ENTID JSON to run live')
      return
    }
    ...
    let object_ref01_data = Object.values(setup.data.existing.object)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['MET_MUSEUM_COLLECTION_TEST_OBJECT_ENTID']
