...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MET_MUSEUM_COLLECTION_TEST_LIVE ||
    'TRUE' === process.env.MET_MUSEUM_COLLECTION_TEST_OVERRIDE
  ) {
  ...
  m.MET_MUSEUM_COLLECTION_TEST_EXPLAIN = process.env.MET_MUSEUM_COLLECTION_TEST_EXPLAIN || m.MET_MUSEUM_COLLECTION_TEST_EXPLAIN
