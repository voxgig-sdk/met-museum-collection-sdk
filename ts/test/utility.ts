...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.METMUSEUMCOLLECTION_TEST_LIVE ||
    'TRUE' === process.env.METMUSEUMCOLLECTION_TEST_OVERRIDE
  ) {
  ...
  m.METMUSEUMCOLLECTION_TEST_EXPLAIN = process.env.METMUSEUMCOLLECTION_TEST_EXPLAIN || m.METMUSEUMCOLLECTION_TEST_EXPLAIN
